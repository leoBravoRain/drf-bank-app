...
SECRET_KEY = "django-insecure-do$)!(av0x$_tza@3v!b2h3@=r6^bv!+-!3#e1fqcv7hz9e=_9"
...
# TODO: check what apps are not needed (sessions maybe)
INSTALLED_APPS = [
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",  # Redis DB 1
        "OPTIONS": {
